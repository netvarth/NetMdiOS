...
- (void)viewDidLoad
{
    ...
    _patientDetailsView = [[PatientDetailsView alloc] initWithFrame:CGRectMake(90.0f, 82.0f, 600.0f, 790.0f)];
    //_currentMedCondView = [[CurrentMedConditionView alloc] initWithFrame:CGRectMake(0.0f, 82.0f, 768.0f, 815.0f)];
    _currentMedCondView = [[CurrentMedConditionView alloc] initWithFrame:CGRectMake(90.0f, 82.0f, 600.0f, 790.0f)];
    _historyView = [[History alloc] initWithFrame:CGRectMake(90.0f, 82.0f, 600.0f, 790.0f)];
