...
#import "PatientRxViewController.h"
#import "PatientHeaderDetailsView.h"
@interface PatientRxViewController ()<UITableViewDataSource,UITableViewDelegate>
...
-(IBAction)newRxPrsd:(id)sender;
@end

@implementation PatientRxViewController
...
-(IBAction)newRxPrsd:(id)sender
{
    UIViewController* vc = [self.storyboard instantiateViewControllerWithIdentifier:@"NewMedicationViewController"];
