...
-(IBAction)AppLstPrsd:(id)sender;
-(IBAction)NewAppPrsd:(id)sender;
...
{
    CGRect frame = CGRectMake(0.0f, 79.0f, 768.0f, 897.0f);
    [self loadViewControllers:@"PatientApptLstViewController" withCGrect:(CGRect)frame];
}

-(IBAction)NewAppPrsd:(id)sender
{
    CGRect frame = CGRectMake(0.0f, 79.0f, 768.0f, 897.0f);
    [self loadViewControllers:@"PatientNewApptViewController" withCGrect:(CGRect)frame];
}
